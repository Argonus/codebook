...
config :checkers, Checkers.Mailer, adapter: Swoosh.Adapters.Local

config :checkers_web,
  ecto_repos: [Checkers.Repo],
  generators: [context_app: :checkers]
...
config :checkers_web, CheckersWeb.Endpoint,
  ...
  live_view: [signing_salt: "Uuka2yje"]
...
config :esbuild,
  ...
  checkers_web: [
    ...
    cd: Path.expand("../apps/checkers_web/assets", __DIR__),
